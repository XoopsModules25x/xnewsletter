...
define('_AM_XNEWSLETTER_CAT_DELETE_ERROR', 'Fehler Newsletterkategorie löschen: Es müssen zuvor alle Abonnenten von dieser Kategorie abgemeldet werden!');
...
define('_AM_XNEWSLETTER_TEMPLATE_SET', 'Alle Newsletter dieser Vorlage zuordnen');
define('_AM_XNEWSLETTER_TEMPLATE_TYPE_FILE_INFO', "*) Wenn Sie eine Dateivorlage aus der Liste entfernen möchten müssen Sie auch die Dateivorlage selbst aus dem Verzeichnis '%s' löschen");
define('_AM_XNEWSLETTER_PROTOCOL_STATUS_VARS', 'Status Details');
define('_AM_XNEWSLETTER_MAINTENANCE_DELETE_INVALID_SUBCR_CATDEL', 'Anmeldungen zu Kategorie löschen, wenn Kategorie nicht mehr besteht');
define('_AM_XNEWSLETTER_SUBSCR_IP', 'Sender IP');
define('_AM_XNEWSLETTER_SUBSCR_ACTKEY', 'Aktivierungsschlüssel');
define('_AM_XNEWSLETTER_SUBSCR_ACTOPTIONS', 'Aktivierungsoptionen');
