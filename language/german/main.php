...
//1.3
define('_MD_XNEWSLETTER_SUBSCRIBE', 'Ab- / Anmelden');
define('_MD_XNEWSLETTER_LIST', 'Newsletterliste');
define('_MD_XNEWSLETTER_LIST_SUBSCR', 'Abonnenten auflisten');
define('_MD_XNEWSLETTER_LETTER_CREATE', 'Erzeuge Newsletter');
define('_MD_XNEWSLETTER_LETTER_EDIT', 'Bearbeite Newsletter');
define('_MD_XNEWSLETTER_LETTER_DELETE', 'Lösche Newsletter');
define('_MD_XNEWSLETTER_LETTER_COPY', 'Kopiere Newsletter');
