...
// set template
$templateMain = 'xnewsletter_admin_feedback.tpl';

$adminObject = \Xmf\Module\Admin::getInstance();

$feedback = new \XoopsModules\Xnewsletter\Common\ModuleFeedback();
...
switch ($op) {
    ...
    case 'send':
        ...
        $error = '<div align="center" style="width: 80%; padding: 10px; border: 2px solid #ff0000; color: #ff0000; margin-right:auto;margin-left:auto;">
