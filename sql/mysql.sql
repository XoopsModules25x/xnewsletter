...
CREATE TABLE `xnewsletter_accounts` (
    ...
    `accounts_created`        INT(10)      NOT NULL DEFAULT '0',
...
CREATE TABLE `xnewsletter_catsubscr` (
    ...
    `catsubscr_created`   INT(10) NOT NULL DEFAULT '0',
...
CREATE TABLE `xnewsletter_letter` (
    ...
    `letter_sent`       INT(10)      NOT NULL DEFAULT '0',
...
CREATE TABLE `xnewsletter_protocol` (
    ...
    `protocol_status_str_id` TEXT         NULL,
    `protocol_status_vars`   TEXT         NULL,
...
CREATE TABLE `xnewsletter_bmh` (
    ...
    `bmh_submitter`   INT(8)       NOT NULL DEFAULT '0',
...
CREATE TABLE `xnewsletter_task` (
    ...
    `task_created`   INT(10) NOT NULL DEFAULT '0',
    PRIMARY KEY (`task_id`),
