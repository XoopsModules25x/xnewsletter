...
define('_XNEWSLETTER_PROTOCOL_STATUS_EMPTY',                0);
...
define('_XNEWSLETTER_PROTOCOL_STATUS_ERROR_PHPMAILER',      6);
define('_XNEWSLETTER_PROTOCOL_STATUS_ERROR_SEND_COUNT',     7);
define('_XNEWSLETTER_PROTOCOL_STATUS_OK_SEND_COUNT',        8);
define('_XNEWSLETTER_PROTOCOL_STATUS_OK_MAILINGLIST',       9);
define('_XNEWSLETTER_PROTOCOL_STATUS_OK_SEND_MAILINGLIST',  10);
define('_XNEWSLETTER_PROTOCOL_STATUS_CRON',                 11);
define('_XNEWSLETTER_PROTOCOL_STATUS_SKIP_IMPORT',          12);
define('_XNEWSLETTER_PROTOCOL_STATUS_ERROR_IMPORT',         13);
define('_XNEWSLETTER_PROTOCOL_STATUS_OK_IMPORT',            14);
define('_XNEWSLETTER_PROTOCOL_STATUS_EXIST_IMPORT',         15);

// constants for import_status
define('_XNEWSLETTER_IMPORT_STATUS_TOCHECK', 0);
define('_XNEWSLETTER_IMPORT_STATUS_IMPORTABLE', 1);
