    ...
    default:
        ...
        if ($bhmCount > 0) {
            ...
            foreach ($bhmObjs as $bhm_id => $bhmObj) {
                ...
                echo "    <a href='?op=bmh_delsubscr&bmh_id=" . $bhm_id . "&filter=" . $filter . "'><img src=" . XNEWSLETTER_ICONS_URL . "/xn_quit.png alt='" . _AM_XNEWSLETTER_BMH_MEASURE_DELETE
                    . "' title='" . _AM_XNEWSLETTER_BMH_MEASURE_DELETE . "' /></a>";
                echo "    <a href='?op=edit_bmh&bmh_id=" . $bhm_id . "'><img src=" . XNEWSLETTER_ICONS_URL . "/xn_edit.png alt='" . _AM_XNEWSLETTER_BMH_EDIT . "' title='" . _AM_XNEWSLETTER_BMH_EDIT
                    . "' width='16px' /></a>";
                echo "    <a href='?op=delete_bmh&bmh_id=" . $bhm_id . "'><img src=" . XNEWSLETTER_ICONS_URL . "/xn_delete.png alt='" . _AM_XNEWSLETTER_BMH_DELETE . "' title='"
