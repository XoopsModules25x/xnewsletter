...
// IN PROGRESS
    ...
    case 'list_letter':
        ...
        //
        if ($letter_id > '0') {
            $protocolAdmin->addItemButton(_AM_XNEWSLETTER_LETTER_DELETE_ALL, '?op=delete_protocol_list&letter_id=' . $letter_id, 'delete');
        }
...
// IN PROGRESS
    ...
    case 'delete_protocol':
        ...
        if (xnewsletterRequest::getBool('ok', false, 'POST') == true) {
            ...
            xoops_confirm(
                array('ok' => true, 'protocol_id' => $_REQUEST['protocol_id'], 'op' => 'delete_protocol'),
                $_SERVER['REQUEST_URI'],
    ...
    case 'delete_protocol_list':
        ...
        if ($letter_id > 0) {
            ...
            if (xnewsletterRequest::getBool('ok', false, 'POST') == true) {
                ...
                xoops_confirm(
                    array('ok' => true, 'letter_id' => $letter_id, 'op' => 'delete_protocol_list'),
                    $_SERVER['REQUEST_URI'],
                    sprintf(_AM_XNEWSLETTER_FORMSUREDEL_LIST, $letterObj->getVar('letter_title'))
                );
            }
        }
        break;
