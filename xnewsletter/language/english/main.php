...
define('_MA_XNEWSLETTER_PLEASE_LOGIN', "The email address %s belongs to a registered user. <br /> please <a href='" . XOOPS_URL
    . "/user.php?xoops_redirect=/modules/xnewsletter/subscription.php'>login</a> to change the data.");
