...
function xnewsletter_plugin_getinfo_weblinks()
{
    ...
    $pluginInfo['tables'][0] = $GLOBALS['xoopsDB']->prefix('weblinks_link');
 ...
 * @return int
 */
function xnewsletter_plugin_getdata_weblinks($cat_id, $checkSubscrsAfterRead = true, $checkLimit, $skipCatsubscrExist = true)
{
    ...
    $sql .= " FROM {$GLOBALS['xoopsDB']->prefix('weblinks_link')}";
