...
function xnewsletter_plugin_getinfo_subscribers()
{
    ...
    $pluginInfo['tables'][0] = $GLOBALS['xoopsDB']->prefix('subscribers_user');
 ...
 * @return int
 */
function xnewsletter_plugin_getdata_subscribers($cat_id, $checkSubscrsAfterRead = true, $checkLimit, $skipCatsubscrExist = true)
{
    ...
    $sql .= " FROM {$GLOBALS['xoopsDB']->prefix('subscribers_user')}";
