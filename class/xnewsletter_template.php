...
/**
 * Class xnewsletter_template
 */
class xnewsletter_template extends XoopsObject
{
    ...
    public function getForm($action = false)
    {
        ...
        $form->addElement(new XoopsFormEditor(_AM_XNEWSLETTER_TEMPLATE_CONTENT, "template_content", $editor_configs), true);
...
/**
 * Class xnewsletterxnewsletter_templateHandler
 */
class xnewsletterxnewsletter_templateHandler extends XoopsPersistableObjectHandler
{
    /**
    ...
    {
        parent::__construct($db, "xnewsletter_template", "xnewsletter_template", "template_id", "template_title");
        $this->xnewsletter = xnewsletterxnewsletter::getInstance();
    }
}
